...
public class JwtHandler {
    ...
    public JwtHandler(IConfiguration configuration, UserManager<MusicUser> userManager) {
        _configuration = configuration;
        _userManager = userManager;
    }

    public async Task<JwtSecurityToken> GetTokenAsync(MusicUser user) =>
        new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(MusicUser user) {
